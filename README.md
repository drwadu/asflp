...
-  in order to tighten the truth bounds of atoms according to the assumption that the Clark's Completion of the input program, we then use a downward pass to propagate that the root node of the LNN has lower bound 1.0 and upper bound 1.0;
